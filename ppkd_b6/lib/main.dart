...
import 'package:ppkd_b6/api3/screen/splash_screen.dart' as ppkd_api3_splash;
  ...
  Widget build(BuildContext context) {
    return MultiProvider(
      ...
      child: MaterialApp(
        ...
        initialRoute:
            CryptoSplashScreen.routeName, // Set as default for testing
        routes: {
          ...
          CryptoSplashScreen.routeName: (context) => const ppkd_api3_splash.Api3SplashScreen(),
        },
      ),
    );
  }
