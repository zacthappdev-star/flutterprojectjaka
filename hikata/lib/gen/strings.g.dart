...
class _StringsQuizId {
	...
	String get unlockKatakana => 'Dapatkan skor 80% di Quiz Hiragana untuk membuka';
...
class _StringsFeedbackId {
	...
	late final _StringsFeedbackRatingsId ratings = _StringsFeedbackRatingsId._(_root);
}
...
class _StringsFeedbackRatingsId {
	_StringsFeedbackRatingsId._(this._root);

	final Translations _root; // ignore: unused_field

	// Translations
	String get veryBad => '😞 Sangat Kecewa';
	String get notSatisfied => '😕 Kurang Puas';
	String get okay => '😐 Cukup';
	String get satisfied => '😊 Puas';
	String get outstanding => '🤩 Luar Biasa!';
}
...
class _StringsEn extends Translations {
	...
	@override late final _StringsQuizIntroEn quizIntro = _StringsQuizIntroEn._(_root);
	@override late final _StringsMissionsEn missions = _StringsMissionsEn._(_root);
}
...
class _StringsHomeEn extends _StringsHomeId {
	...
	@override String get claim => 'CLAIM';
}
...
class _StringsQuizEn extends _StringsQuizId {
	...
	@override String get descListeningMixed => 'Listening challenge combining Hiragana & Katakana';
	@override String get unlockPreviousQuiz => 'Complete the previous quiz';
	@override String get unlockKatakana => 'Get 80% score in Hiragana Quiz to unlock';
	@override String get unlockBoss => 'Get 80% score in Hiragana & Katakana Quizzes';
	...
	@override String get resultCorrect => '✅ Correct Answers';
	@override String get resultWrong => '❌ Wrong Answers';
	@override String get resultTime => '⏱ Time Taken';
	@override String get resultAccuracy => '🎯 Accuracy';
	@override String get resultBackToHome => 'Back to Home';
	@override String get resultTryAgain => 'Try Again';
	@override String get resultOtherQuiz => 'Other Quiz';
	@override String resultXpEarned({required Object xp}) => '✨ +${xp} XP earned!';
	@override String get resultFeedbackExcellent => 'Excellent! よくできました！';
	@override String get resultFeedbackGood => 'Good job! いいね！';
	@override String get resultFeedbackRetry => 'Keep trying! がんばって！';
	@override String get resultAnswer => 'answer';
}
...
class _StringsErrorsEn extends _StringsErrorsId {
	...
	@override String get audioNotAvailable => 'Audio is not available';
	@override String get loadFailed => 'Failed to load data. Please try again.';
...
class _StringsFeedbackEn extends _StringsFeedbackId {
	...
	@override late final _StringsFeedbackRatingsEn ratings = _StringsFeedbackRatingsEn._(_root);
}
...
class _StringsQuizIntroEn extends _StringsQuizIntroId {
	...
	// Translations
	@override String get readyTitle => 'Material Complete!';
...
class _StringsMissionsEn extends _StringsMissionsId {
	...
	// Translations
	@override String get lesson => 'Complete 1 New Lesson';
	@override String get quizMixed => 'Play 1 Mixed Mode Quiz';
	@override String get streak => 'Keep a 3-Day Streak';
}
...
// Path: feedback.ratings
class _StringsFeedbackRatingsEn extends _StringsFeedbackRatingsId {
	_StringsFeedbackRatingsEn._(_StringsEn root) : this._root = root, super._(root);

	@override final _StringsEn _root; // ignore: unused_field

	// Translations
	@override String get veryBad => '😞 Very Disappointed';
	@override String get notSatisfied => '😕 Not Satisfied';
	@override String get okay => '😐 Okay';
	@override String get satisfied => '😊 Satisfied';
...
extension on Translations {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			...
			case 'quiz.unlockKatakana': return 'Dapatkan skor 80% di Quiz Hiragana untuk membuka';
			case 'quiz.unlockBoss': return 'Dapatkan skor 80% di Quiz Hiragana & Katakana';
			...
			case 'quiz.resultCorrect': return '✅ Jawaban Benar';
			case 'quiz.resultWrong': return '❌ Jawaban Salah';
			case 'quiz.resultTime': return '⏱ Waktu Selesai';
			case 'quiz.resultAccuracy': return '🎯 Akurasi';
			case 'quiz.resultBackToHome': return 'Kembali ke Beranda';
			case 'quiz.resultTryAgain': return 'Coba Lagi';
			case 'quiz.resultOtherQuiz': return 'Quiz Lain';
			case 'quiz.resultXpEarned': return ({required Object xp}) => '✨ +${xp} XP didapat!';
			case 'quiz.resultFeedbackExcellent': return 'Luar Biasa! よくできました！';
			case 'quiz.resultFeedbackGood': return 'Bagus! いいね！';
			case 'quiz.resultFeedbackRetry': return 'Coba Lagi! がんばって！';
			case 'quiz.resultAnswer': return 'answer';
			...
			case 'errors.audioNotAvailable': return 'Audio tidak tersedia';
			case 'errors.loadFailed': return 'Gagal memuat data. Silakan coba lagi.';
			case 'errors.retry': return 'Coba Lagi';
			...
			case 'feedback.ratings.veryBad': return '😞 Sangat Kecewa';
			case 'feedback.ratings.notSatisfied': return '😕 Kurang Puas';
			case 'feedback.ratings.okay': return '😐 Cukup';
			case 'feedback.ratings.satisfied': return '😊 Puas';
			case 'feedback.ratings.outstanding': return '🤩 Luar Biasa!';
			case 'quizIntro.readyTitle': return 'Materi Selesai!';
...
extension on _StringsEn {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			...
			case 'quiz.descListeningMixed': return 'Listening challenge combining Hiragana & Katakana';
			case 'quiz.unlockPreviousQuiz': return 'Complete the previous quiz';
			case 'quiz.unlockKatakana': return 'Get 80% score in Hiragana Quiz to unlock';
			case 'quiz.unlockBoss': return 'Get 80% score in Hiragana & Katakana Quizzes';
			...
			case 'quiz.audioType': return 'Audio';
			case 'quiz.resultCorrect': return '✅ Correct Answers';
			case 'quiz.resultWrong': return '❌ Wrong Answers';
			case 'quiz.resultTime': return '⏱ Time Taken';
			case 'quiz.resultAccuracy': return '🎯 Accuracy';
			case 'quiz.resultBackToHome': return 'Back to Home';
			case 'quiz.resultTryAgain': return 'Try Again';
			case 'quiz.resultOtherQuiz': return 'Other Quiz';
			case 'quiz.resultXpEarned': return ({required Object xp}) => '✨ +${xp} XP earned!';
			case 'quiz.resultFeedbackExcellent': return 'Excellent! よくできました！';
			case 'quiz.resultFeedbackGood': return 'Good job! いいね！';
			case 'quiz.resultFeedbackRetry': return 'Keep trying! がんばって！';
			case 'quiz.resultAnswer': return 'answer';
			...
			case 'errors.audioNotAvailable': return 'Audio is not available';
			case 'errors.loadFailed': return 'Failed to load data. Please try again.';
			case 'errors.retry': return 'Try Again';
			...
			case 'feedback.ratings.veryBad': return '😞 Very Disappointed';
			case 'feedback.ratings.notSatisfied': return '😕 Not Satisfied';
			case 'feedback.ratings.okay': return '😐 Okay';
			case 'feedback.ratings.satisfied': return '😊 Satisfied';
			case 'feedback.ratings.outstanding': return '🤩 Outstanding!';
			case 'quizIntro.readyTitle': return 'Material Complete!';
